      ...
      filters: [
        ...
        { 
          ...
          onButtonClick: (value?: any, e?: React.MouseEvent<HTMLElement>) => {
            ...
            window.open((globalThis as any).__toAppUrl(`/popup/customer-search?customerNumber=${customerNumber}&accountNumber=${accountNumber}&openerTabId=${tabId}`), 'CustomerSearch', 'width=1600,height=800');
          }
        },
        ...
        { 
          ...
          onButtonClick: (value?: any, e?: React.MouseEvent<HTMLElement>) => {
            ...
            window.open((globalThis as any).__toAppUrl(`/popup/branch-management?branchCode=${branchCode}&branchName=${branchName}&openerTabId=${tabId}`), 'BranchManagement', 'width=1600,height=800');
          }
        },
        ...
        { 
          ...
          onButtonClick: (value?: any, e?: React.MouseEvent<HTMLElement>) => {
            ...
            window.open((globalThis as any).__toAppUrl(`/popup/user-search?usrno=${usrno}&usrNm=${usrNm}&openerTabId=${tabId}`), 'UserSearch', 'width=1600,height=800');
          }
        },
        ...
        if (id === 'progressStatus') {
          return {
            ...
            onClick: () => {
              ...
              window.open((globalThis as any).__toAppUrl('/popup/asset-soundness-progress'),
        ...
        if (id === 'auditOpinion') {
          return {
            ...
            onClick: () => {
              ...
              window.open((globalThis as any).__toAppUrl(`/popup/soundness-audit-opinion?openerTabId=${tabId}&selectedMonth=${selectedMonth}&monthOptions=${monthOptions}`),
    ...
    <div className="flex flex-col gap-3">
      ...
      <DataTable
        ...
        onRowDoubleClick={(row) => {
          ...
          window.open((globalThis as any).__toAppUrl(`/popup/bond-legal-progress?residentRegistrationNumber=${dummyRrn}`),
            'BondLegalProgress',
