      ...
      filters: [
        { 
          ...
          onButtonClick: (value?: any, e?: React.MouseEvent<HTMLElement>) => {
            ...
            window.open((globalThis as any).__toAppUrl(`/popup/customer-search?customerNumber=${customerNumber}&sourceFilter=customerNumber`), 'CustomerSearch', 'width=1600,height=800');
          }
        },
        ...
        { 
          ...
          onButtonClick: (value?: any, e?: React.MouseEvent<HTMLElement>) => {
            ...
            const name = value || '';
             // openerTabId removed
            window.open((globalThis as any).__toAppUrl(`/popup/customer-search?customerName=${name}&sourceFilter=applicantName`), 'CustomerSearch', 'width=1600,height=800');
          }
        },
