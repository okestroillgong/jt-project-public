      ...
      filters: [
        { 
          ...
          onButtonClick: (value?: any, e?: React.MouseEvent<HTMLElement>) => {
            ...
            window.open((globalThis as any).__toAppUrl(`/popup/customer-search?birthDate=${birthDate}&openerTabId=${tabId}&sourceFilter=birthDate`), 'CustomerSearch', 'width=1600,height=800');
          }
        },
        {
      ...
      filters: [
        ...
        { 
          ...
          onButtonClick: (value?: any, e?: React.MouseEvent<HTMLElement>) => {
            ...
            window.open((globalThis as any).__toAppUrl(`/popup/customer-search?customerNumber=${customerNumber}&openerTabId=${tabId}&sourceFilter=customerNumber`), 'CustomerSearch', 'width=1600,height=800');
          }
        },
