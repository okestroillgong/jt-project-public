...
export default function CollectiveRegistrationOfBondsForSalePage() {
  ...
  //   window.open((globalThis as any).__toAppUrl(//     `/popup/multi-excel-download`),
  //     "MultiExcelDownload",
  ...
  const handleExcelDownload = () => {
    ...
    window.open((globalThis as any).__toAppUrl(`/popup/excel-download?columns=${encodedColumns}`),
      "ExcelDownload",
      `width=${width},height=${height},left=${left},top=${top}`
    );
  };
