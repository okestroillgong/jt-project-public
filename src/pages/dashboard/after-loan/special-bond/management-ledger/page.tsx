      ...
      filters: [
        { 
          ...
          onButtonClick: (value?: any, e?: React.MouseEvent<HTMLElement>) => {
            ...
            window.open((globalThis as any).__toAppUrl(`/popup/customer-search?customerNumber=${customerNumber}&customerName=${customerName}&openerTabId=${tabId}&sourceFilter=customerNumber`), 'CustomerSearch', 'width=1600,height=800');
          }
        },
        { 
          name: "customerName", 
