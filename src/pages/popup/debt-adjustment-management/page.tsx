            ...
            <div className="flex justify-end gap-2">
                ...
                <Button
                    ...
                    onClick={() => {
                        ...
                        window.open((globalThis as any).__toAppUrl(`/popup/debt-adjustment-e-signature?openerTabId=${openerTabId}`),
                ...
                <Button
                    ...
                    onClick={() => {
                        const popupWidth = 1600;
                        const popupHeight = 800;
                        window.open((globalThis as any).__toAppUrl(`/popup/abstract-and-payment?openerTabId=${openerTabId}`),
