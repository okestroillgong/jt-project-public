      ...
      filters: [
        { 
          ...
          onButtonClick: (value?: any) => {
            ...
            window.open((globalThis as any).__toAppUrl(`/popup/customer-search?customerNumber=${customerNumber}&accountNumber=${accountNumber}&openerTabId=${openerTabId}`), 'CustomerSearch', 'width=1600,height=800');
          }
        },
        ...
        { 
          ...
          onButtonClick: (value?: any) => {
            ...
            window.open((globalThis as any).__toAppUrl(`/popup/branch-management?branchCode=${branchCode}&branchName=${branchName}&openerTabId=${openerTabId}`), 'BranchManagement', 'width=1600,height=800');
          }
        },
