      ...
      filters: [
        ...
        { 
          ...
          onButtonClick: (value: any, e: any) => {
             ...
             window.open((globalThis as any).__toAppUrl(`/popup/branch-management?branchName=${branchName}&branchCode=${branchCode}&openerTabId=${tabId}`), 'BranchManagement', 'width=1600,height=800');
          }
        },
        {
          name: "usrRsppDstcd",
